...
I hold a Master's degree in Control Science and Engineering from Beijing Institute of Technology (2018-2021) and a Bachelor's degree in Automation from Nanjing Agricultural University (2014-2018). Currently, I work as a Senior Algorithm Engineer at Hangzhou iMedAI, where I focus on developing LLM-based academic writing agents, RAG systems, and AI-powered platforms for traditional Chinese medicine.
...
- **Development Tools**: Docker, Git, FastAPI, Altium Designer
- **AI/ML Frameworks**: PyTorch, TensorFlow, Scikit-learn
- **Areas of Expertise**: Machine Learning, Deep Learning, Computer Vision, Natural Language Processing, Robotics, Biomedical Signal Processing

## Publications & Patents

I have multiple publications in IEEE Transactions on Robotics and Physiological Measurement, as well as several patents in medical AI and robotic systems. My work focuses on bridging the gap between AI technology and practical medical applications.
...
**Download my CV**: [CV_Yangming Guo.pdf](/assets/files/CV_Yangming%20Guo.pdf)

---

*This website is built using Jekyll and the Minimal Mistakes theme, hosted on GitHub Pages.*